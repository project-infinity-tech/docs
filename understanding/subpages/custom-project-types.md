...
This tells Scram to look up your custom type by name rather than using a built-in primitive. You'll use this pattern when declaring page variables, component properties, and component variables that hold structured data.
...
<CardGroup cols={2}>
  <Card title="Understanding Data Types" href="/understanding/understanding-data-types" />
