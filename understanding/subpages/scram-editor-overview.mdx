...
The Scram editor is where you build your app. It has three distinct views, each with a different purpose — the **Canvas**, the **Workflow Editor**, and **Resources**. You switch between them depending on what you're working on.
