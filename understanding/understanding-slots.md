...
When you place a component inside another in the editor, you're placing it into a slot. If the parent has multiple slots, you can choose which one to target.
...
<CardGroup cols={3}>
  ...
  <Card title="Understanding Repeaters" href="/understanding/understanding-repeaters" />
